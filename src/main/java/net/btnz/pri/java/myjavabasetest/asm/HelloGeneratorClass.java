...
public class HelloGeneratorClass implements Opcodes {
    public static byte[] generatorHelloClass() throws Exception {
        ...
        cw.visit(V1_7, ACC_PUBLIC + ACC_SUPER, "net/btnz/pri/java/myjavabasetest/asm/Hello", null, "java/lang/Object", null);
        ...
        }
        {
            ...
            mv.visitFrame(Opcodes.F_FULL, 8,
                    new Object[]{"net/btnz/pri/java/myjavabasetest/asm/Hello", Opcodes.INTEGER, "[Ljava/util/Map;",
            ...
            mv.visitLabel(l2);
            mv.visitFrame(Opcodes.F_FULL, 4, new Object[]{"net/btnz/pri/java/myjavabasetest/asm/Hello", Opcodes.INTEGER,
    ...
    public static void main3(String[] args) {
        try {
            ...
            File file = new File(System.getProperty("user.dir")+System.getProperty("file.separator")+"Hello.class");
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> helloClass = myClassLoader.defineClass("net.btnz.pri.java.myjavabasetest.asm.Hello", data);
